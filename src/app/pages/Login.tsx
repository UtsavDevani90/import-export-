      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <Link to="/" className="flex items-center gap-3 mb-8">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center text-[#0a0a0a] font-bold text-xl" style={{ background: "linear-gradient(135deg,#d4a017,#b8860b)" }}>T</div>
            <div>
              <div className="text-white font-bold text-base" style={{ letterSpacing:"0.12em" }}>TANZORA</div>
              <div className="text-[#d4a017] text-[9px]" style={{ letterSpacing:"0.3em" }}>EXPORT CO.</div>
            </div>
          </Link>
